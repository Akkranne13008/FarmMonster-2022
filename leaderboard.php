...
$mysqli = new mysqli("mysql-farmmonster.alwaysdata.net", "290423", "", "farmmonster_bdd");
$mysqli->set_charset("utf8");
$requete = 'SELECT * FROM Utilisateur ORDER BY Level_FarmMonster DESC';
$resultat = $mysqli->query($requete);

	while ($reponse_stats = $resultat->fetch_assoc())
  {
      echo'
          <p>'. $reponse_stats['Pseudo']. ' '. $reponse_stats['Level_FarmMonster']. '</p>        
    ';
}
