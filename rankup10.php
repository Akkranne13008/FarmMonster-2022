...
$insertUser=$bdd->exec("UPDATE Utilisateur SET Gold=Gold - 100 WHERE Pseudo='$pseudo'");
$insertUser=$bdd->exec("UPDATE Utilisateur SET Level_FarmMonster=Level_FarmMonster + 10 WHERE Pseudo='$pseudo'");
