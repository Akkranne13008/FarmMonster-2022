...
$insertUser=$bdd->exec("UPDATE Utilisateur SET Gold=Gold - 150 WHERE Pseudo='$pseudo'");
$insertUser=$bdd->exec("UPDATE Utilisateur SET Perm_World=Perm_World + 1 WHERE Pseudo='$pseudo'");
