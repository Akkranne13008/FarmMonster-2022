...
<div class="wrapper">
    ...
    <div class="main_content">
        ...
        <?php
           ...
           <form action="wood3.php" method="post">	
           <button class="fas fa-tree" style="color:#966F33">  ' . $reponse['Bois'] .'</button>
           </form>
           <form action="plante3.php" method="post">
           <button class="fas fa-seedling" style="color:#046307">  ' . $reponse['Plante'] .'</button>
           </form>
           <form action="gem3.php" method="post">
           <button class="fas fa-gem" style="color:#52aef8">  ' . $reponse['Gem'] .'</button>
           </form>
           ';
